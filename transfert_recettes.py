...
def function_special_Unit(lignes_temp):
	lignes_temp=lignes_temp.replace('c à soupe','CS').replace('c à café','CC').replace('Litres','L').replace('litres','L').replace("gouttes",'GT')
	Unit=["L","l","dl","dcl","cl","ml","Kg","kg","g","mg","CS","CC","GT"]
	special=[","]
	temp2=""
